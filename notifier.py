...
class PersonalScheduleNotifier:
    ...
    "«Сила характера — в ежедневной борьбе, а не в редких триумфах.» — (философия дисциплины)",
        ...
        self.schedule = {
            'monday': {
                'утро': ['Взвеситься (Цель 85 кг)', 'Сделай Зарядку (кнопка "Старт" для твоей энергии)', 'Прими Витамины (это топливо для мозга)', 'Сделай комплимент Марте и Саше (твои девочки почувствуют себя важными и любимыми)', 'Посмотреть Амо блог на youtube', 'English на Youtube 20 min', 'Девиз дня: Ничего не бойся и не сдавайся!', 'Включи Мозг'],
            ...
            'friday': {
                'утро': ['Взвеситься (Цель 85 кг)', 'Сделай Зарядку (кнопка "Старт" для твоей энергии)', 'Прими Витамины (это топливо для мозга)', 'Сделай комплимент Марте и Саше (твои девочки почувствуют себя важными и любимыми)', 'Посмотреть Амо блог на youtube', 'English на Youtube 20 min', 'Девиз дня: Ничего не бойся и не сдавайся!', 'Включи Мозг'],
                'день': ['Читать 25 минут (спорт для мозга)', 'HH у Самурая нет оффера только отклики', 'Позвонить тете Ларисе', 'Подтянуться min 12 раз', 'Упражнение на пресс 2 подхода min 16 раз', 'Молчание золото. Не перебивай (Молчание строит доверие)'],
                'нельзя_день': ['Ругаться матом (Мат это мусора - ты мусор?)', 'Д (Слил энергию — слил фокус)', 'Пить алкоголь (Он крадет твою энергию, деньги и внешность)'],
            ...
            'saturday': {
                'утро': ['Взвеситься (Цель 85 кг)', 'Сделай Зарядку (кнопка "Старт" для твоей энергии)', 'Прими Витамины (это топливо для мозга)', 'Сделай комплимент Марте и Саше (твои девочки почувствуют себя важными и любимыми)', 'Посмотреть Амо блог на youtube', 'Девиз дня: Ничего не бойся и не сдавайся!'],
